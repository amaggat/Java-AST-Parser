...
public class JciaDomHelper {
    ...
    static public class DOMBuilder implements ContentHandler {
         ...
         * @param parentNode the parent node
         */
        public DOMBuilder(SAXTransformerFactory factory, org.w3c.dom.Node parentNode) {
    ...
    public static class StartHandler extends DefaultHandler {
        ...
        public InputSource resolveEntity(String publicId, String systemId) {
            // dont ask me for dtds
            return new InputSource(new ByteArrayInputStream(new byte[0]));
//            if (dtdMappings != null && dtdMappings.containsKey(publicId)) {
//                String dtdFile = dtdMappings.get(publicId);
//                return new InputSource(ClassLoaderUtil.getResourceAsStream(dtdFile, com.opensymphony.xwork2.util.DomHelper.class));
//            } else {
