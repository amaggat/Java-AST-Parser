...
import Project.JciaDependency;
import Project.JciaData;
import Project.JciaDependency;
...
public class Node implements Serializable {
    ...
    @JsonIgnore
    @JciaIgnore
    protected List<JciaDependency> dependencies;
    ...
    public List<JciaDependency> getDependencies() {
        return dependencies;
    }

    public void addJciaDependency(JciaDependency dependencies) {
        this.dependencies.add(dependencies);
    }

    public void addDependencies(List<JciaDependency> dependencies) {
        this.dependencies.addAll(dependencies);
    }

    public void setDependencies(List<JciaDependency> dependencies) {
...
//    }
    ...
    public List<Node> getCallees() {
        ...
        for (JciaDependency d : dependencies) {
